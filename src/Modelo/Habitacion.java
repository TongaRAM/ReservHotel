...
public class Habitacion {
    ...
    public String habitacionSimple(){
        this.descripcion = "SERVICIOS DE LA HABITACIÓN\n"
                +" \n"
                + "-Cuenta con una cama individual\n"
                + "de plaza y media\n"
                + "-Dispone de un baño con agua\n"
                + " caliente\n"
    ...
    public String habitacionDoble(){
         this.descripcion = "SERVICIOS DE LA HABITACIÓN\n"
                 +" \n"
                 + "-Cuenta con dos camas indoviduales\n"
                 + "o una cama doble\n"
                 + "-Dispone de dos baños con agua fria\n "
                 + "y caliente\n"
    ...
    public String habitacionTriple(){
        this.descripcion = "SERVICIOS DE LA HABITACIÓN\n"
                ...
                + "-Servicio a la habitación\n"
                + "-Dispone de tres baños con agua fría\n"
                + "y caliente\n"
                + "-Velador\n"
                + "-Aire acondicionado\n"
                + "-TV por cable\n";
    ...
    public String habitacionConnectingRooms(){
        this.descripcion = "SERVICIOS DE LA HABITACIÓN\n"
                +" \n"
                +"-Cuenta con habitaciones conectadas\n "
                + "entre sí\n"
                + "-Servicio a la habitación\n"
                + "(desayuno/almuerzo/cena)\n"
                + "-Cuenta con jacuzzi\n"
